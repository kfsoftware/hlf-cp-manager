...
import (
	...
	"github.com/kfsoftware/hlf-cp-manager/log"
	"github.com/kfsoftware/hlf-cp-manager/server"
...
'serve' command starts the server API`
	serveExample = `hlf-cp-manager serve --address="0.0.0.0:8080" --config=./config.yaml`
)
